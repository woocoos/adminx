...
func (ec *executionContext) _PolicyRule_effect(ctx context.Context, field graphql.CollectedField, obj *types.PolicyRule) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPolicyEffect2githubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyEffect(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputPolicyRuleInput(ctx context.Context, obj interface{}) (types.PolicyRule, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "effect":
			...
			it.Effect, err = ec.unmarshalNPolicyEffect2githubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyEffect(ctx, v)
			if err != nil {
				return it, err
			}
		case "actions":
...
func (ec *executionContext) unmarshalNPolicyEffect2githubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyEffect(ctx context.Context, v interface{}) (types.PolicyEffect, error) {
	var res types.PolicyEffect
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNPolicyEffect2githubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyEffect(ctx context.Context, sel ast.SelectionSet, v types.PolicyEffect) graphql.Marshaler {
	return v
}

func (ec *executionContext) marshalNPolicyRule2githubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyRule(ctx context.Context, sel ast.SelectionSet, v types.PolicyRule) graphql.Marshaler {
	return ec._PolicyRule(ctx, sel, &v)
}

func (ec *executionContext) marshalNPolicyRule2ᚕgithubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyRuleᚄ(ctx context.Context, sel ast.SelectionSet, v []types.PolicyRule) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPolicyRule2githubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyRule(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) unmarshalNPolicyRuleInput2githubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyRule(ctx context.Context, v interface{}) (types.PolicyRule, error) {
	res, err := ec.unmarshalInputPolicyRuleInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNPolicyRuleInput2ᚕgithubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyRuleᚄ(ctx context.Context, v interface{}) ([]types.PolicyRule, error) {
	var vSlice []interface{}
	if v != nil {
		vSlice = graphql.CoerceList(v)
	}
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalNPolicyRuleInput2githubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyRule(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalOPolicyRuleInput2ᚕgithubᚗcomᚋwoocoosᚋadminxᚋgraphᚋentgenᚋtypesᚐPolicyRuleᚄ(ctx context.Context, v interface{}) ([]types.PolicyRule, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []interface{}
