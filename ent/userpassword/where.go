...
func StatusEQ(v Status) predicate.UserPassword {
	return predicate.UserPassword(sql.FieldEQ(FieldStatus, v))
}

// StatusNEQ applies the NEQ predicate on the "status" field.
func StatusNEQ(v Status) predicate.UserPassword {
	return predicate.UserPassword(sql.FieldNEQ(FieldStatus, v))
}

// StatusIn applies the In predicate on the "status" field.
func StatusIn(vs ...Status) predicate.UserPassword {
	return predicate.UserPassword(sql.FieldIn(FieldStatus, vs...))
}

// StatusNotIn applies the NotIn predicate on the "status" field.
func StatusNotIn(vs ...Status) predicate.UserPassword {
	return predicate.UserPassword(sql.FieldNotIn(FieldStatus, vs...))
}
