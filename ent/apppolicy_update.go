...
func (apu *AppPolicyUpdate) SetStatus(ts types.SimpleStatus) *AppPolicyUpdate {
	apu.mutation.SetStatus(ts)
	return apu
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (apu *AppPolicyUpdate) SetNillableStatus(ts *types.SimpleStatus) *AppPolicyUpdate {
	if ts != nil {
		apu.SetStatus(*ts)
	}
	return apu
...
// SetStatus sets the "status" field.
func (apuo *AppPolicyUpdateOne) SetStatus(ts types.SimpleStatus) *AppPolicyUpdateOne {
	apuo.mutation.SetStatus(ts)
	return apuo
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (apuo *AppPolicyUpdateOne) SetNillableStatus(ts *types.SimpleStatus) *AppPolicyUpdateOne {
	if ts != nil {
		apuo.SetStatus(*ts)
	}
	return apuo
